...
export class CreateTables1734033991588 implements MigrationInterface {
  name = 'CreateTables1734033991588';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "reviews" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "isApproved" boolean NOT NULL DEFAULT false, "projectId" integer, CONSTRAINT "REL_ee90086bb783380da5453d240b" UNIQUE ("projectId"), CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
